...
2.  기분에 따라 컨텐츠 추천을 받고 싶은 경우 '기분 맞춤형 컨텐츠 추천받기'를 선택합니다.
    다양한 테마에 따른 영화들을 추천 받고 싶은 경우 '요즘 인기있는 컨텐츠 추천받기'를 선택합니다.
     챗봇에 대한 다양한 정보를 원하신다면 '서비스 소개'를 선택합니다.

2-1. '기분 맞춤형 컨텐츠 추천받기'를 선택한 경우 
2-1.1 이름을 입력합니다. 
2-1.2. 얼굴이 들어간 사진을 업로드합니다. 
2-1.3. 사진 분석 결과가 나오면 분석 결과가 맞는지 확인합니다.

2-2. '요즘 인기있는 컨텐츠 추천받기'를 선택한 경우
2-2.1 원하는 추천테마를 선택합니다.
2-2.2 테마에 따른 추천 콘텐츠 목록이 나옵니다.

2-3. '서비스 소개'를 선택한 경우
2-3.1 챗봇 서비스에 대한 자세한 설명이 필요한 경우, '서비스 더 알아보기를 선택합니다.
2-3.2 사용방법에 대해 알고 싶은 경우, '사용 방법'을 선택합니다.
